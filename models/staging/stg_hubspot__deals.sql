...
renamed as (
    select
        ...
        {{ safe_cast('property_hs_deal_stage_probability', 'numeric') }}    as deal_stage_probability,
        {{ safe_cast('property_amount', 'numeric') }}                       as amount,
        {{ safe_cast('property_amount_in_home_currency', 'numeric') }}      as amount_home_currency,
        {{ safe_cast('property_createdate', 'timestamp') }}                 as deal_created_at,
        {{ safe_cast('property_closedate', 'timestamp') }}                  as deal_close_date,
        {{ safe_cast('property_hs_closed_won_date', 'timestamp') }}         as deal_closed_won_at,
        coalesce({{ safe_cast('property_hs_is_closed_won', 'bool') }}, false)  as is_closed_won,
        coalesce({{ safe_cast('property_hs_is_closed', 'bool') }},
